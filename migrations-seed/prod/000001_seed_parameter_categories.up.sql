-- Production baseline: base parameter categories for the canonical organization.
-- org_id matches the ecosystem canonical org (auth7 prod/demo: 00000000-0000-0000-0000-000000000001).
-- Category metadata only — actual parameter values are managed via the Admin API per org.
